...
#define EVENT_UPDATE_MSG        (0x00001000)
#define EVENT_ON_SLEEP          (0x00002000)
#define EVENT_REPORT_VERSION    (0x00004000)
...
#define EVENT_UPDATE_MSG        (0x00001000)
#define EVENT_ON_SLEEP          (0x00002000)
#define EVENT_CLOSE_BUZZER      (0x00004000)
#define EVENT_READ_TRANSIENT      (0x00008000)
