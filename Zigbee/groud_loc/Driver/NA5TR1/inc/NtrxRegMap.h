...
#ifndef _NTRXREGMAP_H_
#define _NTRXREGMAP_H_
...
typedef enum
{
	...
	NA_FctPeriod,
	//0x28
	NA_BasebandTimerStartValue,
	//0x2a
	NA_SyncWord,
	//0x2a
	NA_ToaOffsetMeanAck,
	//0x2b
	NA_ToaOffsetMeanAckValid,
	//0x2c
	NA_TxRespTime,
	//0x2e
	NA_PhaseOffsetData,
...
//WO
  ...
  #define NA_RangingPulseint8_t_VC_C                        (0x3)
  #define NA_RangingPulseint16_t_VC_C                       (0x4)
  #define NA_RangingPulses24_VC_C                       (0x5)
  #define NA_RangingPulseint32_t_VC_C                       (0x6)
...
// the number of bits used for crypt bits
  ...
  #define NA_MacPreambleSymbolint8_t000ns_IC_C              (14)
  #define NA_MacPreambleSymbolint16_t000ns_IC_C             (12)

  #define NA_CrystalFrequency_IC_C                      (32)

#endif	// _NTRXREGMAP_H_
