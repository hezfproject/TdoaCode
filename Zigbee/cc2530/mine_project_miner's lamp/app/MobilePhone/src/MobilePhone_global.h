...
Revised:        $Date: 2011/08/24 18:07:51 $
...
#define WORK_STATUS_STOPMIC                 (0x08)
//typedef struct
//{
...
typedef struct
{
    uint8       setted;				// have setted phone number by keyboard   1:true 	0:false
    uint8 	    checkxor; 			// checkxor = HI(phone_number) ^ LO(phone_number)
    uint16 	    phone_number;
} MP_NumberInfo_t;
/*************************************************************************************************
*MACROS
...
#define SET_ON_STOPMIC() MP_SetStatus(WORK_STATUS_STOPMIC)
/*************************************************************************************************
* global variables
*/
/* common device info */
