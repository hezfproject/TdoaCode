...
#define MAX_CONVEYOR_INFO_NUM           50
#define MAX_CONVEYOR_CMD_NUM           10
...
typedef struct
{
    termNbr_t       num;//uint8              num[NMBRDIGIT];
...
//infotype
#define  INFOTYPE_STOP     0x08
#define  INFOTYPE_DEMAND     0x09

typedef struct
{
    uint8   num;//Conveyor number
    uint8   status;//Conveyor status
    uint8   infotype;
    uint8   malfunction_type;
    uint8  	malfunction_msg; 
    uint8   speed;		
    uint8   tensility;	
    uint8   date[DATE_LEN];
    uint8   time[TIME_LEN];	
    Conveyor_head_t  head;	
}  Conveyor_sms_t;
...
#define MP_NV_SMS_INBOX_END                  MP_NV_SMS_INBOX_BASE+MAX_SMS_NUM-1    //0x04A6


#define F_MP_NV_CONVEYOR_01                0x04A7
#define F_MP_NV_CONVEYOR_02                0x04A8
#define F_MP_NV_CONVEYOR_03                0x04A9
#define F_MP_NV_CONVEYOR_04                0x04AA
#define F_MP_NV_CONVEYOR_05                0x04AB
#define F_MP_NV_CONVEYOR_06                0x04AC
#define F_MP_NV_CONVEYOR_07                0x04AD
#define F_MP_NV_CONVEYOR_08                0x04AE
#define F_MP_NV_CONVEYOR_09                0x04AF
#define F_MP_NV_CONVEYOR_0A                0x04B0

#define F_MP_NV_CONVEYOR_0B                0x04B1
#define F_MP_NV_CONVEYOR_0C                0x04B2
#define F_MP_NV_CONVEYOR_0D                0x04B3
#define F_MP_NV_CONVEYOR_0E                0x04B4
#define F_MP_NV_CONVEYOR_0F                0x04B5
#define F_MP_NV_CONVEYOR_10                0x04B6
#define F_MP_NV_CONVEYOR_11                0x04B7
#define F_MP_NV_CONVEYOR_12                0x04B8
#define F_MP_NV_CONVEYOR_13                0x04B9
#define F_MP_NV_CONVEYOR_14                0x04BA

#define F_MP_NV_CONVEYOR_15                0x04BB
#define F_MP_NV_CONVEYOR_16                0x04BC
#define F_MP_NV_CONVEYOR_17                0x04BD
#define F_MP_NV_CONVEYOR_18                0x04BE
#define F_MP_NV_CONVEYOR_19                0x04BF
#define F_MP_NV_CONVEYOR_1A                0x04C0
#define F_MP_NV_CONVEYOR_1B                0x04C1
#define F_MP_NV_CONVEYOR_1C                0x04C2
#define F_MP_NV_CONVEYOR_1D                0x04C3
#define F_MP_NV_CONVEYOR_1E                0x04C4

#define F_MP_NV_CONVEYOR_1F                0x04C5
#define F_MP_NV_CONVEYOR_20                0x04C6
#define F_MP_NV_CONVEYOR_21                0x04C7
#define F_MP_NV_CONVEYOR_22                0x04C8
#define F_MP_NV_CONVEYOR_23                0x04C9
#define F_MP_NV_CONVEYOR_24                0x04CA
#define F_MP_NV_CONVEYOR_25                0x04CB
#define F_MP_NV_CONVEYOR_26                0x04CC
#define F_MP_NV_CONVEYOR_27                0x04CD
#define F_MP_NV_CONVEYOR_28                0x04CE

#define F_MP_NV_CONVEYOR_29                0x04CF
#define F_MP_NV_CONVEYOR_2A                0x04D0
#define F_MP_NV_CONVEYOR_2B                0x04D1
#define F_MP_NV_CONVEYOR_2C                0x04D2
#define F_MP_NV_CONVEYOR_2D                0x04D3
#define F_MP_NV_CONVEYOR_2E                0x04D4
#define F_MP_NV_CONVEYOR_2F                0x04D5
#define F_MP_NV_CONVEYOR_30                0x04D6
#define F_MP_NV_CONVEYOR_31                0x04D7
#define F_MP_NV_CONVEYOR_32                0x04D8

#define F_MP_NV_CONVEYOR_33                0x04D9
#define F_MP_NV_CONVEYOR_34                0x04DA
#define F_MP_NV_CONVEYOR_35                0x04DB
#define F_MP_NV_CONVEYOR_36                0x04DC
#define F_MP_NV_CONVEYOR_37                0x04DD
#define F_MP_NV_CONVEYOR_38                0x04DE
#define F_MP_NV_CONVEYOR_39                0x04DF
#define F_MP_NV_CONVEYOR_3A                0x04E0
#define F_MP_NV_CONVEYOR_3B                0x04E1
#define F_MP_NV_CONVEYOR_3C                0x04E2


#define MP_CONVEYOR_INFO_BASE                F_MP_NV_CONVEYOR_01
#define MP_CONVEYOR_INFO_END                  MP_CONVEYOR_INFO_BASE+MAX_CONVEYOR_INFO_NUM-1    //0x04D8

#define MP_CONVEYOR_CMD_BASE                F_MP_NV_CONVEYOR_01+MAX_CONVEYOR_INFO_NUM
#define MP_CONVEYOR_CMD_END                  MP_CONVEYOR_CMD_BASE+MAX_CONVEYOR_CMD_NUM-1    //0x04E2

#if 1
//#ifdef MENU_RF_DEBUG
#define ZCD_NV_SET_CHANLIST     0x04E3
#define ZCD_NV_SET_PANID           0x04E4
#define MINEAPP_NV_SET_INFORMATION        0x04E5//set information include volume, backlight and time
#define MP_NV_R_OR_D_ITEM            		0x04E6
#define MP_SMS_SEQNUM					0x04E7
#else
...
extern bool Is_inContact_SearchContactByNum_and_item(Contact_Node *pContactNode,uint16 contact_item, const uint8* pNum);


void  Add_CallRecord(uint8, Record*);
extern void menu_Record_nv_init(void);
...
extern uint8 menu_SMS_Search_Inbox(app_SMS_t *pSMS);
...
extern void menu_Conveyor_nv_init(void);
extern uint8 int_Conveyor_item_L(void);
extern uint8 menu_Conveyor_Read_Num(uint8 *pNum,conveyor_type conveyortype);
extern uint8 menu_Conveyor_Read_Conveyor(Conveyor_sms_t *pConveyor,uint8 idx,conveyor_type conveyortype);
extern uint8 menu_Conveor_Add(Conveyor_sms_t *pConveyor,conveyor_type conveyortype);
extern uint8 Conveyor_List_Get_FirstValid_Item(uint16 *head_item,conveyor_type conveyortype);
extern bool menu_Conveyor_Search_Inbox(app_Conveyor_info_t *pConveyor);
