...
{
    mbus_hdr_slv.mbus_tlv.mbus_sensor_packed.mbus_sensor [10].value = u16Big_To_Little(0xFFFF);
    mbus_hdr_slv.mbus_tlv.mbus_sensor_packed.mbus_sensor [11].value = u16Big_To_Little(0x0000);
}
