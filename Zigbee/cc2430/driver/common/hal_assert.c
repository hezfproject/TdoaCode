/**************************************************************************************************
  ...
  Revised:        $Date: 2009/10/16 23:50:25 $
...
#if ((defined HAL_AUDIO) && (HAL_AUDIO == TRUE)) || (defined MINE_CONTROLLER)
static  void halPrintAssertMSG(void);
#endif
/**************************************************************************************************
 * @fn          halAssertHandler
 *
...
#if ((defined HAL_AUDIO) && (HAL_AUDIO == TRUE)) || (defined MINE_CONTROLLER)
 void halPrintAssertMSG(void)
{
	BACKLIGHT_OPEN();
	InitialLcd();
    LcdClearDisplay();
#ifndef NEW_MENU_LIB
    LCD_Str_Print("No Exit Address ",sizeof("No Exit Address "),0,1, TRUE);
#else
    LCD_Str_Print("No Exit Address ", 0,1, TRUE);
#endif
    while(1);
}
#endif
