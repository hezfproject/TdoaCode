/**************************************************************************************************
  ...
  Revised:        $Date: 2009/03/20 00:05:10 $
 ...
 *                                             TYPEDEFS
 ***************************************************************************************************/
typedef void (__near_func *halTimerCBack_t) (uint8 timerId, uint8 channel, uint8 channelMode);
 ...
 */
extern __near_func void HalTimerTick ( void );
