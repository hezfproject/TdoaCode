...
#define MINEAPP_AUDIO_START_EVT    0x0008
#define MINEAPP_AUDIO_STOP_EVT     0x0010
#define MINEAPP_RING_EVENT              0x0020
#endif
#if ((defined HAL_AUDIO) && (HAL_AUDIO == TRUE)) || (defined MINE_CONTROLLER)
#define MINEAPP_LCD_PERSIST_EVT     0x0040
#endif
/**************************************************************************************************
 * TYPEDEFS
 **************************************************************************************************/
