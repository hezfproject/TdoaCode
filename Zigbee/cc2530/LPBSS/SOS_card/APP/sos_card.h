...
// 求救上报次数
    ...
    #define HELP_REPORT_MAX     12//(HELP_REPORT * (LOCATE_TIME / HELP_FLASH_TIME))
#endif

// 低电门限，0.1v单位
#ifndef VDD_LIMITE
    #define VDD_LIMITE              (45)
#endif

// 按键事件定义
#ifndef KEY_HELP_TIME
    #define KEY_HELP_TIME           (200)
#endif

#define LOCATE_TIME                 (REPORT_DELAY_SOS * 1000)           // to sec
