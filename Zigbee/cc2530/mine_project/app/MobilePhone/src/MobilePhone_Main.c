/**************************************************************************************************
Filename:       mp_Main.c
Revised:        $Date: 2011/04/03 00:23:18 $
...
void MobilePhone_Main_KeyCallback(uint8 keys, uint8 state);
...
int main(void)
{
	...
	HalKeyConfig(MP_KEY_INT_ENABLED, MobilePhone_Main_KeyCallback);
