...
void Menu_UpdateSMS(void)
{
	...
	if(curIndex != 0x0F && smsSum >=curIndex)
	{
		...
		if((sDisSmsIndex == disSmsIndex) && (smsSum != 1))
		{
			return;
		}
...
{
	uint8 offset = 1;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+index));
	offset += 8;
	HalLcd_Page_Char(0,offset,CHAR_6X12_ASCII,(uint16)('-'));
	offset += 6;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+(time.hour)/10));
	offset += 8;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+(time.hour)%10));
	offset += 8;
	HalLcd_Page_Char(0,offset,CHAR_6X12_ASCII,(uint16)(':'));
	offset += 6;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+(time.min)/10));
	offset += 8;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+(time.min)%10));
	offset += 16;

	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+date.mon/10));
	offset += 8;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+date.mon%10));
	offset += 8;
	//HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('/'));
	HalLcd_HW_Page_GB(0,offset,4,CHAR_15X16_GB2312,"月");
	offset += 16;
    HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+date.day/10));
    offset += 8;
    HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)('0'+date.day%10));
	offset += 8;
	HalLcd_HW_Page_GB(0,offset,4,CHAR_15X16_GB2312,"日");
	offset += 12;
	HalLcd_Page_Char(0,offset,CHAR_8X16_ASCII,(uint16)(':'));
