...
static void    menu_main_display(void)
{
	...
	LCD_Str_Print((uint8 *)V2_CARD_CHINA, (LCD_LINE_WIDTH-osal_strlen((char *)V2_CARD_CHINA))/2, 1,TRUE);
	LCD_Str_Print((uint8 *)SEARCH_CHECK_CHINA, (LCD_LINE_WIDTH-osal_strlen((char *)SEARCH_CHECK_CHINA))/2, 2,TRUE);
}
