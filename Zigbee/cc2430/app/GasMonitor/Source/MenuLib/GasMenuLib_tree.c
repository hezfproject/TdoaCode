...
static char*  const __code  ItemList_CHECKCARD[]= {V1CARDCHECK_CHINA,V2CARDCHECK_CHINA};
...
static Tree_node_t  const __code Menu_Tree[] =
{
    ...
    */
    ...
    #ifdef  CHECK_V2_CARD   
    {
        ...
        .ParentID = MENU_ID_FUNCTIONLIST,
        .FirstChildID =MENU_ID_V1CARDCHECK,//NULL,
        .ChildNum = sizeof(ItemList_CHECKCARD)/sizeof(ItemList_CHECKCARD[0]),
        .ItemName_CH = ItemList_CHECKCARD,
        .oper.display = menu_list_display,
    ...
    ,
    {
        .ID = MENU_ID_V1CARDCHECK,
        .name = V1CARDCHECK_CHINA,
        .ParentID = MENU_ID_CARDCHECK,
        .FirstChildID =NULL,
        .ChildNum = 0,
        .ItemName_CH = NULL,
        .oper.display = menu_CardCheck_display,
    ...
    ,
    {
        .ID = MENU_ID_V2CARDCHECK,
        .name = V2CARDCHECK_CHINA,
        .ParentID = MENU_ID_CARDCHECK,
        .FirstChildID =NULL,
        .ChildNum = 0,
        .ItemName_CH = NULL,
...
{
    #ifdef  CHECK_V2_CARD                   
       if( MENU_ID_V2CARDCHECK==CurrentNodeID)
        {
...
#ifdef CFG_GAS_CARDCHECK
    #ifdef  CHECK_V2_CARD             
       else if((CurrentNodeID == MENU_ID_V1CARDCHECK||CurrentNodeID == MENU_ID_V2CARDCHECK)
    #else
       else if((CurrentNodeID == MENU_ID_CARDCHECK) 
    #endif
        && rssi > -7)  // for card check
    {
