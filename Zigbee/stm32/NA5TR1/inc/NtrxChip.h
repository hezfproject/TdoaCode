...
#define RANGING_SUCCESSFULL 4    // SUCCESSFULL means : all data is collected, ready to calculate now
    ...
    extern uint8 RangingFollowIndicateFlag;
...
#define    PREVTXID            9
#define ACTTXID             10
#define RANGE_NORMAL_SIZE   11
#define RANGE_FOLLOW_INDICATE     11
#define RANGE_FOLLOW_SIZE         12
#define RANGE_ARRYLEN       127             // Length of rangingpacket
