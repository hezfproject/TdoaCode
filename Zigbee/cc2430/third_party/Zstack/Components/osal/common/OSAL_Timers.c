/**************************************************************************************************
  ...
  Revised:        $Date: 2010/07/22 05:36:04 $
...
static uint32 osal_systemClockUs;
#endif
/*********************************************************************
...
#ifdef CFG_PRECISE_TIMER
uint32 osal_TimerElapsedUs(void);
#endif
/*********************************************************************
 * FUNCTIONS
 *********************************************************************/
 ...
 * @return  none
 *********************************************************************/
__near_func void osalTimerUpdate( uint16 updateTime )
{
  halIntState_t intState;
  osalTimerRec_t *srchTimer;
 ...
 * @return  none
 */
__near_func  void osal_update_timers( void )
{
#ifdef CFG_PRECISE_TIMER
	osal_systemClockUs += osal_TimerElapsedUs();
	osalTimerUpdate(osal_systemClockUs/1000);
	osal_systemClockUs %= 1000;
#else
  	osalTimerUpdate( tmr_decr_time );
#endif
}
#ifdef CFG_PRECISE_TIMER
uint32 osal_TimerElapsedUs()
{	
	...
	uint32 time = tick_delta*125UL*125UL/512UL;  //unit us;
	ticks_old = ticks;
	return time;
}
#endif
