...
Revised:        $Date: 2011/05/04 00:03:33 $
...
#define MP_STOP_AUDIO_TIMEOUT 	10000
...
#define MP_SHORT_GATEWAYNMBR GATEWAYNMBR
#define MP_SHORT_INVALIDNMMBR INVALIDNMMBR

#define APP_SMS_MAX_LEN  SMS_MAX_LEN
#define APP_NMBRDIGIT NMBRDIGIT
