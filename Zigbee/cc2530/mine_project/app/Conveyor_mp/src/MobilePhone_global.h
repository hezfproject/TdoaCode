...
#define WORK_STATUS_CONVEYOR_SENDING          (0x08)
typedef struct
{
    bool abnormalRst;
    bool backLightOn;
...
#define ON_CONVEYOR_SENDING() MP_JudgeStatus(WORK_STATUS_CONVEYOR_SENDING)
...
#define SET_ON_CONVEYOR_SENDING() MP_SetStatus(WORK_STATUS_CONVEYOR_SENDING)
