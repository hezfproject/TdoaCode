...
#define ZCD_NV_SECURE_PRECFG_TCLINKKEY    0x0066
#define ZCD_NV_SECURE_TCLINKKEY_TXFRAME   0x0067     // Trust Center Link Key tx Frame counter
#define ZCD_NV_SECURE_TCLINKKEY_RXFRAME   0x0068     // Trust Center Link Key rx Frame counter
