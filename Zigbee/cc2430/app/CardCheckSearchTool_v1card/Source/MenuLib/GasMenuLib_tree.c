...
#endif
static char*  const __code  ItemList_SEARCHCARD[]= {V1CARDSEARCH_CHINA,V1CARDNUMSEARCH_CHINA};
...
static Tree_node_t  const __code Menu_Tree[] =
{
    ...
    */
...
#endif
    {
        ...
        .ParentID = MENU_ID_FUNCTIONLIST,
        .FirstChildID =MENU_ID_V1CARDSEARCH,
...
#endif
{
    ...
    ,
    {
        .ID = MENU_ID_V1CARDSEARCH,
        .name = V1CARDSEARCH_CHINA,
    ...
    ,
    {
        .ID = MENU_ID_V1CARDNUMSEARCH,
        .name = V1CARDNUMSEARCH_CHINA,
        .ParentID = MENU_ID_CARDSEARCH,
        .FirstChildID =NULL,
        .ChildNum = 0,
        .ItemName_CH = NULL,
    ...
    ,
    {
        .ID = MENU_ID_V1_CARDSEARCH_RESULT,
        .name =NULL,
        .ParentID = MENU_ID_V1CARDSEARCH,
        .FirstChildID = NULL,
        .ChildNum = 0,
        .ItemName_CH = NULL,
    ...
    ,
    {
        .ID = MENU_ID_V1_CARDNUMSEARCH_RESULT,
        .name = NULL,
        .ParentID = MENU_ID_V1CARDNUMSEARCH,
        .FirstChildID = NULL,
        .ChildNum = 0,
        .ItemName_CH = NULL,
...
void menu_CardSearch_result_onkey(uint8 keys, uint8 status)
{
    ...
    {
    case HAL_KEY_MODE:
        if( MENU_ID_V1_CARDNUMSEARCH_RESULT==CurrentNodeID)
        {
...
void menu_CardInfo_receive(uint16 CardID, int8 rssi)
{
    ...
    if(CurrentNodeID==MENU_ID_V1_CARDSEARCH_RESULT)
    {
        uint8 CardSiglevel  = GasMonitor_RSSI2Level(rssi);
        menu_FillCardInfo(CardID,CardSiglevel);
    }
    if(CurrentNodeID==MENU_ID_V1_CARDNUMSEARCH_RESULT)
    {
...
void updataSearchCardOvertime(void)
{
    ...
    else if(CurrentNodeID == MENU_ID_V1_CARDSEARCH_RESULT)
    {
