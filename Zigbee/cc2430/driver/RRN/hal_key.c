/**************************************************************************************************
Filename:       hal_key.c
Revised:        $Date: 2010/09/06 23:15:08 $
...
//#if 1 && defined (HAL_BOARD_YIRICHAEGEED)    // p2_0
...
#endif
#if  (defined HAL_BOARD_CHAEGEED)    		// P1_7
#define HAL_KEY_SW_7_ENABLE   /* YIRRN or BFN key - SW7 is enabled based on key interrupt enable or not - see config */
#define HAL_KEY_SW_7_PORT     P1                      /* Port location of SW7 */
#define HAL_KEY_SW_7_BIT      HAL_KEY_BIT7            /* Bit location of SW7 */
#define HAL_KEY_SW_7_SEL      P1SEL                   /* Port Select Register for SW7 */
#define HAL_KEY_SW_7_DIR      P1DIR                   /* Port Direction Register for SW7 */
#define HAL_KEY_SW_7_INP      P1INP                   /* Port Input Mode Register for SW7 */
#define HAL_KEY_SW_7_IEN      IEN2                    /* Interrupt Enable Register for SW7 */
#define HAL_KEY_SW_7_IENBIT   HAL_KEY_BIT4            /* Interrupt Enable bit for SW7 */
#define HAL_KEY_SW_7_EDGE     HAL_KEY_FALLING_EDGE    /* Type of interrupt for SW7 */
#define HAL_KEY_SW_7_EDGEBIT  HAL_KEY_BIT1            /* EdgeType enable bit SW7 */
#define HAL_KEY_SW_7_ICTL     P1IEN                   /* Port Interrupt Control for SW7 */
#define HAL_KEY_SW_7_ICTLBIT  HAL_KEY_BIT7            /* Interrupt enable bit for SW7 */
#define HAL_KEY_SW_7_PXIFG    P1IFG                   /* Port Interrupt Flag for SW7 */

#define HAL_KEY_P0INT_LOW_USED    0   				 /* smooth compiling error*/
#define HAL_KEY_POINT_HIGH_USED   0                   /* P0 can only be enabled/disabled as group of high or low nibble */
#endif

#if  (defined HAL_BOARD_CHAEGEED)                    // P1_6
#define HAL_KEY_SW_6_ENABLE   /* YIRRN or BFN key - SW7 is enabled based on key interrupt enable or not - see config */
#define HAL_KEY_SW_6_PORT     P1                      /* Port location of SW7 */
#define HAL_KEY_SW_6_BIT      HAL_KEY_BIT6            /* Bit location of SW7 */
#define HAL_KEY_SW_6_SEL      P1SEL                   /* Port Select Register for SW7 */
#define HAL_KEY_SW_6_DIR      P1DIR                   /* Port Direction Register for SW7 */
#define HAL_KEY_SW_6_INP      P1INP                   /* Port Input Mode Register for SW7 */
#define HAL_KEY_SW_6_IEN      IEN2                    /* Interrupt Enable Register for SW7 */
#define HAL_KEY_SW_6_IENBIT   HAL_KEY_BIT4            /* Interrupt Enable bit for SW7 */
#define HAL_KEY_SW_6_EDGE     HAL_KEY_FALLING_EDGE    /* Type of interrupt for SW7 */
#define HAL_KEY_SW_6_EDGEBIT  HAL_KEY_BIT1            /* EdgeType enable bit SW7 */
#define HAL_KEY_SW_6_ICTL     P1IEN                   /* Port Interrupt Control for SW7 */
#define HAL_KEY_SW_6_ICTLBIT  HAL_KEY_BIT6            /* Interrupt enable bit for SW7 */
#define HAL_KEY_SW_6_PXIFG    P1IFG                   /* Port Interrupt Flag for SW7 */
...
#elif defined (HAL_BOARD_CHAEGEED)
	P2INP &= ~(0x01<<6); 		/* set port 1 to poll up*/
#endif 
...
#if (defined HAL_BOARD_YIRIRRN) || (defined HAL_BOARD_CHAEGEED)
  //halProcessKeyInterrupt();
  #if defined (HAL_KEY_SW_7_ENABLE)
  if (HAL_KEY_SW_7_PXIFG & HAL_KEY_SW_7_BIT)      /* Interrupt Flag has been set */
  {
