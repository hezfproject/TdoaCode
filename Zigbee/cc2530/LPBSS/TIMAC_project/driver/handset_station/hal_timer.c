...
*******************************************************************************
********************/
__near_func void HalTimerTick (void)
{
...
void halProcessTimer1 (void)
{
  if (halTimerRecord[halTimerRemap(HAL_TIMER_3)].channelMode == HAL_TIMER_CH_MODE_OUTPUT_COMPARE)
  {
    ...
    //{
    //  T1STAT &= ~(T1STAT_CH3IF);
    //  halTimerSendCallBack (HAL_TIMER_3, HAL_TIMER_CHANNEL_D, HAL_TIMER_CH_MODE_OUTPUT_COMPARE);
    //}
    //if (T1STAT & T1STAT_CH4IF)
    //{
    //  T1STAT &= ~(T1STAT_CH4IF);
    //  halTimerSendCallBack (HAL_TIMER_3, HAL_TIMER_CHANNEL_E, HAL_TIMER_CH_MODE_OUTPUT_COMPARE);
    //}    
  }
