...
#ifndef SMS_INFO_PG     
#define SMS_INFO_PG					(FLASH_START_PG +3)
#define SMS_INFO_OFFSET				(61)  
#define SMS_DIS_HEADER_LEN			 12
#define SMS_INFO_LEN_MAX			(SMS_INFO_OFFSET - SMS_DIS_HEADER_LEN-1)// -时间日期(12bytes)-长度(1byte)
#define SMS_NUMBER_MAX			     5
#endif


//#ifdef DEV_CARD_PROJ
#define FLASH_PAGE_OFFSET   4
//#else
