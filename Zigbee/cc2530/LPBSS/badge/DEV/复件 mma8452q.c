...
void MMA845x_Init(void)
{
    ...
    HAL_I2C_WriteReg(MMA845x_I2C_ADDRESS, CTRL_REG1, DATA_RATE_1250US | FREAD_MASK);
    ...
    HAL_I2C_WriteReg(MMA845x_I2C_ADDRESS, CTRL_REG3, WAKE_TRANS_MASK | WAKE_FF_MT_1_MASK| PP_OD_MASK | WAKE_PULSE_MASK);
    HAL_I2C_WriteReg(MMA845x_I2C_ADDRESS, CTRL_REG4, INT_EN_PULSE_MASK|INT_EN_FF_MT_1_MASK|INT_EN_TRANS_MASK);
    HAL_I2C_WriteReg(MMA845x_I2C_ADDRESS, CTRL_REG5, INT_CFG_PULSE_MASK |INT_CFG_FF_MT_1_MASK|INT_CFG_TRANS_MASK); //;INT_CFG_PULSE_MASK
	...
	HAL_I2C_WriteReg(MMA845x_I2C_ADDRESS, FF_MT_COUNT_1_REG, 0x03);	//;*80ms
