/**************************************************************************************************
  ...
  Revised:        $Date: 2009/06/02 02:30:18 $
...
#define HAL_KEY_POLLING_VALUE   100
  ...
  #define HAL_KEY_SW_6_BIT      HAL_KEY_BIT3            /* Bit location of SW7 */
  ...
  #define HAL_KEY_SW_6_ICTLBIT  HAL_KEY_BIT3            /* Interrupt enable bit for SW7 */
...
#if 0                     /* P0_1 for debug*/
#if defined (HAL_BOARD_YIRIRRN) || defined(HAL_BOARD_YIRIBFN) //(HAL_BOARD_CC2430EB) || defined (HAL_BOARD_CC2430BB)
  #define HAL_KEY_SW_6_ENABLE
  #define HAL_KEY_SW_6_PORT     P0                      /* Port location of SW1 */
  #define HAL_KEY_SW_6_BIT      HAL_KEY_BIT1            /* Bit location of SW1 */
  #define HAL_KEY_SW_6_SEL      P0SEL                   /* Port Select Register for SW1 */
