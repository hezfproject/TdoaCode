...
static const char __code monday[] = {MONDAY};
static const char __code tuesday[] = {TUESDAY};
static const char __code wednesday[] = {WEDNESDAY};
static const char __code thursday[] = {THURSDAY};
static const char __code friday[] = {FRIDAY};
static const char __code saturday[] = {SATURDAY};
static const char __code sunday[] = {SUNDAY};
