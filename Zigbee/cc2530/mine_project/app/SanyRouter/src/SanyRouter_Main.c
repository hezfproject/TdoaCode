...
void LL_Main_KeyCallback(uint8 keys, uint8 state);
...
int main(void)
{
  ...
  //HalKeyConfig(LL_KEY_INT_ENABLED, LL_Main_KeyCallback);

  /* Blink LED on startup */
  //HalLedBlink (HAL_LED_4, 0, 40, 200);

  /* simulate key press*/
  LL_HandleKeys(HAL_KEY_SW_1, 0);
