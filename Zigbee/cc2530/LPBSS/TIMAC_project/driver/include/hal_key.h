/**************************************************************************************************
  Filename:       hal_key.h
  Revised:        $Date: 2011/04/03 00:23:33 $
...
#define HAL_KEY_SW_6 0x20  // Button S1 if available HELP
#define HAL_KEY_SW_7 0x40  // Button S2 if available CONFIRM

#ifdef _2530_CHARGE_
#define HAL_KEY_HELP    HAL_KEY_SW_6
#define HAL_KEY_CONFIRM HAL_KEY_SW_7
#endif
/* Joystick */
...
#ifdef _2530_CHARGE_
/*
 * key event process callback
 */
extern void     HalKeyProcCallback(uint8);

/*
 * This is for internal used by hal_driver
 */
extern uint8    HalKeyPoll(void);
