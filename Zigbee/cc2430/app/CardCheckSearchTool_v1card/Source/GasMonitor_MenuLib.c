...
#endif
        if(CurrentNodeID==MENU_ID_CARDSEARCH
                ||CurrentNodeID==MENU_ID_V1_CARDSEARCH_RESULT)
        {
            menu_CardSearch_end();
        }
...
#endif
    else if(NearLastNodeID == MENU_ID_V1_CARDSEARCH_RESULT
        ||NearLastNodeID == MENU_ID_V1_CARDNUMSEARCH_RESULT
#ifdef CFG_GAS_SOSALARM
        ||NearLastNodeID == MENU_ID_SOS_ALARM_RESULT
#endif
            )
    {
        menu_JumpBackMarkParent();
...
#endif
    else if(NearLastNodeID == MENU_ID_V1CARDSEARCH)
    {
        menu_JumptoMenu(MENU_ID_V1_CARDSEARCH_RESULT);
    }
    else if(NearLastNodeID == MENU_ID_V1CARDNUMSEARCH)
    {
        menu_JumptoMenu(MENU_ID_V1_CARDNUMSEARCH_RESULT);
    }
