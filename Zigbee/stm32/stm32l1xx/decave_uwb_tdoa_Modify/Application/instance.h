...
/*********************设备参数设置*****************************/
#define DEV_TAG_ANCHOR_ADDRESS          30008    //基站ID
#define DEV_TAG_TEST_ADDRESS            20009    //待测卡ID   10009
#define DEV_TAG_STANDARD_ADDRESS        10007    //学习卡ID
#define SLOW_SPEED_TAG_SEND_TIME  		1000     //待测卡触发周期即待测卡信息发送周期 400
#define QUICK_SPEED_TAG_SEND_TIME   	100      //待测卡触发周期即待测卡信息发送周期 45
