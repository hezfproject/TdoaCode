/**************************************************************************************************
  Filename:       hal_uart.h
  Revised:        $Date: 2010/06/03 06:00:17 $
...
#define HAL_UART_BR_300	   0x09
#define HAL_UART_BR_600	   0x0A

/* Frame Format constant */
#define HAL_UART_LINKFORMAT_0	0x00   // 8 bits/char; no parity; 1 stop bit; stop bit hi.
#define HAL_UART_LINKFORMAT_1	0x01   // 7 bits/char; even  parity; 1 stop bit
#define HAL_UART_LINKFORMAT_2	0x02   // 8 bits/char; even  parity; 1 stop bit
...
#define HAL_UART_WORKMODE_REPORT   0x00
#define HAL_UART_WORKMODE_CMDLINE  0x01

/* UART IO ctrl */
#define HAL_UART_IOCTL_SET        0x00
#define HAL_UART_IOCTL_GET        0x01
#define HAL_UART_IOCTL_FLUSH      0x02
...
typedef struct
{
  ...
  uint8 			workMode;
  halUARTCBack_t    CallBackFuncCmdLine;
  #endif
}halUARTCfg_t;
...
extern void HalUARTFlushTxBuf( uint8 port);

extern void HalUARTFlushRxBuf( uint8 port);
