...
#define LCD_DISPLAY_LOWPOER     9
#define LCD_DISPLAY_POWERON     10
#define LCD_DISPLAY_POWEROFF    11
...
// 按键事件定义
#ifndef KEY_POWEROFF_TIME
    #define KEY_POWEROFF_TIME           (2000)
#endif

#define LOCATE_TIME                 (REPORT_DELAY_BADGE * 1000)           // to sec
