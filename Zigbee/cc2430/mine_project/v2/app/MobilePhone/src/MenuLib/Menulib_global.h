...
#define SMS_NV_LEN                    (APP_SMS_MAX_LEN+APP_NMBRDIGIT+SMS_LEN_TYPE_SIZE)//82
...
enum MenuID
{
    ...
    /* pages in OAD */
#ifdef MENU_OAD_UPDATE
    MENU_ID_OAD_SET_SHORTADDR,
    MENU_ID_OAD_SET_MSGTYPE,
    MENU_ID_OAD_SET_VERSION,
    MENU_ID_OAD_RESULT,
#endif
    /*
