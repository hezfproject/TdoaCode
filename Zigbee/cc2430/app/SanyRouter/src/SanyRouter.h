...
#define LL_KEY_INT_ENABLED       TRUE           /*
                                                 * FALSE = Key Polling
                                                 * TRUE  = Key interrupt
                                                 *
 ...
 */
extern void LL_Init( uint8 task_id );
extern void C2P_Init( uint8 task_id );
extern void C2C_Init( uint8 task_id );

/*
 * Task Event Processor for the Mac Sample Application
 */
extern uint16 LL_ProcessEvent(uint8 taskId, uint16 events);
extern uint16 C2P_ProcessEvent(uint8 taskId, uint16 events);
extern uint16 C2C_ProcessEvent(uint8 taskId, uint16 events);

/*
 * Handle keys
 */
extern void LL_HandleKeys( uint8 keys, uint8 shift );
