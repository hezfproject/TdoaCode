...
#define  HALSHAKEINITIAL(x) st( P1DIR |= 0x01<<2; P1_2 = x;)

#define AUDIO_PER_RAW_DATA_LEN AMBE_RAWDATA_LEN_2400

#define AUDIO_IDX_THRESHOLD  12
...
#define OPENFLAG_NONE    0
#define OPENFLAG_ASBELL 1
#define OPENFLAG_ASSMS   2
...
#define HALRING_SHAKEON()  st(P1_2 = 1;)
#define HALRING_SHAKEOFF() st(P1_2 = 0;)


/**************************************************************************************************
  *FUNCTIONS
  */
extern char*  const __code  BellNameStr_list[RING_BELL_NUM];

/**************************************************************************************************
  *FUNCTIONS
  */
#define HalAudioInit()   InitialAudio()
