...
//TDOA事件定义
#define EVENT_TDOA_CARD_BOARDCAST    (0x00100000)
#define EVENT_CHECKTDOA_REVMSG_EVENT (0x00200000)
#define EVENT_UART_SEND_TDOA         (0x00400000)
#define EVENT_SEND_TOF_POLL          (0x00800000)
