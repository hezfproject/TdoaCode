...
{
    if(u32LedDIO0 < E_AHI_DIO0_INT || u32LedDIO0 > E_AHI_DIO20_INT )
    {
        return FALSE;
    }
...
{
    if(u32LedDIO1 < E_AHI_DIO0_INT || u32LedDIO1 > E_AHI_DIO20_INT )
    {
        return FALSE;
    }
...
{
    if(u32LedDIO2 < E_AHI_DIO0_INT || u32LedDIO2 > E_AHI_DIO20_INT )
    {
        return FALSE;
    }
