/**************************************************************************************************
  ...
  Revised:        $Date: 2010/08/04 23:43:45 $
...
#if (defined RRN) && (!(defined AMMETER_DATACENTER) && !(defined  AMMETER_COLLECTOR)&& !(CARDTRANSFER_DATACENTER) && !(CARDTRANSFER_COLLECTOR))
...
#elif (defined AMMETER_DATACENTER) || (defined  AMMETER_COLLECTOR)|| (defined CARDTRANSFER_DATACENTER) || (defined  CARDTRANSFER_COLLECTOR)
#define LED3_BV           BV(1)
...
#if (defined AMMETER_DATACENTER) || (defined  AMMETER_COLLECTOR)|| (defined CARDTRANSFER_DATACENTER) || (defined  CARDTRANSFER_COLLECTOR)
#define HAL_SET_LED_DIR() \
do { \
  LED1_DDR |= LED1_BV; \
  LED2_DDR |= LED2_BV;  \
  LED3_DDR |= LED3_BV;  \
...
#define HAL_BOARD_INIT() {                                       \
  ...
  P2INP |= PUSH2_BV;                                             \
      			\
  /*set radio frontend setting*/                                     \
  HAL_RADIO_FRONTEND_INIT();               \
}
