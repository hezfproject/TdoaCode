/**************************************************************************************************
  Filename:       ZComDef.h
  Revised:        $Date: 2009/05/22 02:36:22 $
...
// 0xE0 ?0xFF
//the following are used to communication with ARM.
#define SPI_RX     0xE1 //zigbee App will receive a msg from ARM through SPI.
#define APP_LOC   0xE2 //transmit location info from an endpoint to another endpoint on the same device.
#define APP_AUDIO  0xE3 //the audio system message identifier.


#ifdef   CHECK_V2_CARD
#define APP_CHECK_V2_CARD     0xE4 //zigbee App will receive a msg from MAC
